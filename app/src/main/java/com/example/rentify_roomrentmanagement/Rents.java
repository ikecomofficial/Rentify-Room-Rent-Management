...
public class Rents {
    ...
    public String rent_date, rent_time, payment_mode, tenant_name;
    ...
    public Rents(String rent_date, String rent_time, String payment_mode, String tenant_name, int rent_amount) {
